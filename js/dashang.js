$(function(){
    ...
    dashang += '<a class="shang_close" href="javascript:void(0)" title="关闭"><img src="//likexia.gitee.io/game/images/dashang/close.png" alt="关闭" /></a>';
    dashang += '<div class="shang_tit">';
    dashang += '<p>感谢您的支持，我会继续努力的!</p>';
    dashang += '</div>';
    dashang += '<div class="shang_payimg">';
    dashang += '<img src="//likexia.gitee.io/game/images/dashang/alipayimg.png" alt="扫码支持" title="扫一扫" />';
    dashang += '</div>';
    ...
    dashang += '<span class="pay_logo"><img src="//likexia.gitee.io/game/images/dashang/alipay.jpg" alt="支付宝" /></span>';
    dashang += '</div>';
   ...
   $(".pay_item").click(function(){
    		...
    		$(".shang_payimg img").attr("src","//likexia.gitee.io/game/images/dashang/"+dataid+"img.png");
