...
var cnItems = {
    ...
    'Requires Mining Skill': '需要采矿技能',
    'Requires Sigil': '需要徽章',
    'Requires Team account': '需要团队账户',
    'Reset Password': '重置密码',
    'Rewards': '奖励',
    'ridaren': '里达伦',
    'Right click': '右击',
    ...
    'Treasure Chest Key': '',
    'Treasure Map': '',
    'Turns this into snow.': '把它变成雪。',
    'Typo\'s, not game breaking, not urgent': '',
    'Upgrade with': '升级',
    'Upgrading your chisel will yield more stardust when breaking stardust crystals.': '',
    'Upper': '大写',
    'Username will be set to all lowercase.': '用户名将设置为全部小写。',
    'Vendor': '供应商',
    'Vial of Water': '水瓶',
    'Who do you want to mute?': '您想让谁静音？',
    'Will remain Unbound and Tradable.': '',
    'Woodcutting Level Required': '要求伐木等级',
    'Workers': '工人',
    'You can convert your team to casual at any time.': '您可以随时将团队转换为临时团队。',
    'You do not have anyone muted.': '您没有任何人被静音。',
    'You may leave/join as many teams as you wish only if you unlist yourself from leaderboards permanently.': '仅当您永久退出排行榜时，您才可以离开/加入任意数量的团队。',
    'You may only have 1 map at a time, however you may have an infinite amount of chests.': '您一次可能只有一张地图，但是您的箱子数量可能是无限的。',
    'You will have to enter this pin everytime you login from a new location and after server reboots.': '每次从新位置登录后以及服务器重新启动后，都必须输入此PIN。',
    'Your pin must be 4 numbers long.': '您的pin必须为4个数字长。',
    '': '',
    '': '',
    '': '',
    '': '',
