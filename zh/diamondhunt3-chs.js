...
var cnItems = {
    ...
    'SMALL VIALS': '小瓶',
    'Smitty': '斯密蒂',
    'Smutty needs to add combat animations': '斯密蒂需要添加战斗动画',
    'Snake': '蛇',
    'Snake Sushi Shrimp': '蛇寿司虾',
    'Snake Sushi Trout': '蛇寿司鳟鱼',
    'Snake Sushi Tuna': '蛇寿司金枪鱼',
    'Snapegrass Seeds': '草籽',
    'so I can finally finish crafting my arrows.': '这样我就可以完成我的箭了。',
    'Socket': '插槽',
    'Solve': '解决',
    'Stinger': '刺',
    'STINGER': '刺',
    ...
    'Total Casts': '总计施放',
    'WOODEN SHIELD': '木盾',
    'xealleone stop spoil game story': '停止破坏游戏的故事',
    'SKULL': '头骨',
    'Skull': '头骨',
    'Small Shell': '小贝壳',
    'SMALL SHELL': '小贝壳',
    ...
    'I can do it!': '我能做到！',
    'Unlock for': '解锁需要',
    'Unlock with the researcher.': '与研究人员一起解锁。',
    'We need to find a way to get him back into this crystal and destroy it before he destroys the world!↵': '我们需要找到一种方法，来在他毁灭世界之前回到这个水晶并摧毁它！',
    'Where can I find feathers?': '我可以从哪里找到羽毛呢？',
    'which u cant grow anyway': '你无论如何都不能成长',
    'xealleone stop spoil game story': '停止破坏游戏的故事',
    'TREE STARTER': '树起动器',
    'This belonged to the roaming ghost around the farm lands.': '这是一个游荡在农场周围的幽灵。',
    'This doesn\'t help at all.': '这一点用都没有。',
    'This piece of content is currently under construction!': '这块内容目前正在建设中!',
    'This rusty sword should not be used againts enemies with armour as it will break.': '这把生锈的剑不能用来对付带盔甲的敌人，因为它会折断。',
    'This weapon was obtained from being stung by a bee in the fields.': '这种武器是在田野里被蜜蜂蛰后获得的。',
    'todo': '要做',
    'TODO': '要做',
    'Tradable Donor Coins': '可交易的捐赠金币',
    'TREE LIST': '数目列表',
    'Tree Patch': '树木补丁',
    'STRIPED CRYSTAL LEAF': '条纹水晶叶',
    'STRIPED GOLD LEAF': '条纹金叶',
    'Striped Gold Leaf Seeds': '条纹金叶种子',
    'TELESCOPE LENS': '望远镜的镜头',
    'The black dots on the salad is unappetizing.': '沙拉上的黑点让人倒胃口。',
    'The delicious cockroach of the sea.': '海里美味的蟑螂。',
    'THE MISSING FEATHERS': '失踪的羽毛',
    'The rare staff wielded by elite wizards.': '精英巫师使用的稀有魔杖。',
    'The wand found from a fire mage in the lava dungeon.': '从熔岩地下城的一个火法师那里找到的魔杖。',
    'These are currently tradable on the market, to use them in the donor shop; you must first bind them to your account.': '这些目前可以在市场上交易，在捐赠商店使用;你必须首先把它们绑定到你的账户上。',
    'SPELL SCROLL': '魔法卷轴',
    'Stab Attack': '刺',
    'Staff': '魔杖',
    'Still waiting on those': '还在等着',
    'Stolen straight from a rat.': '直接从老鼠那里偷的。',
    'Stops dying level': '停止死亡水平',
    'Store Bananas': '把香蕉',
    'MONSTER LOG': '怪物原木',
    'Monsters that drop regular bones will be doubled.': '掉落普通骨头的怪物将被加倍。',
    'Normally, I would be able to use this as a weapon.  Too bad it\'s broken.': '通常情况下，我可以用它作为武器。真可惜它坏了。',
    'Manta Ray': '蝠鲼',
    'MAGIC STAFF': '魔杖',
    'LIME LEAF': '酸橙叶',
    ...
    'Iron Dagger': '铁匕首',
    'IRON DAGGER': '铁匕首',
    'Is there a reward?': '有奖励吗?',
    'It seems to be attracted to the dark crystal.': '它似乎被黑暗水晶所吸引',
    'Its main source is found from cutting down apple trees using the': '它的主要来源是砍伐苹果树时使用',
    'Its main source is found from cutting down banana trees using the': '它的主要来源是砍伐香蕉树时使用',
    'just adds more types of seeds': '加入更多种类的种子',
    'Large': '大',
    'LARGE PRISM': '大棱镜',
    'Lava Alien': '熔岩外星人',
    'I can use these to socket tools granting them more power.': '我可以使用这些插槽工具授予他们更多的权力。',
    'I have gained 5 skill but unable to get 6 one how could I gain 6 skill': '我获得了5项技能，但没有得到6项，我怎么能获得6项技能呢',
    'i have rake': '我有耙',
    'I have to run.': '我必须逃跑',
    'I refuse': '我拒绝',
    'I said what it was': '我说了是什么',
    'im guessing yeah': '我猜是的',
    'In Progress': '在进行中',
    'in the fields.  However, I only seem to run into bees.': '在田野里。然而，我似乎只遇到了蜜蜂。',
    'Instaly deals fire damage to your enemy.': '首先对你的敌人造成火焰伤害。',
    'Heal instantly during combat.': '在战斗中立即治疗。',
    'heat': '热',
    'Hello there!  Good to finally talk to someone, I\'ve been trying to get someone to help me find some': '你好!很高兴终于能跟人说话了，我一直在找人帮我找',
    'Hi': '你好',
    'HINT': '提示',
    'Honey is very sweet and attracts a lot of bears.  Maybe I should bring some in the caves and kill one!': '蜂蜜很甜，吸引了很多熊。也许我应该带一些到洞里去杀一个!',
    'how do I get dh3 sand?': '我怎么得到dh3沙?',
    'Huge': '巨大',
    'HUGE PRISM': '巨大的棱镜',
    'I can buy one of these everytime I upgrade the shop!': '我每次升级商店都可以买一个!',
    'Glass Hand': '玻璃手',
    'Grants you 12h of offline time instead of 8h.': '授予您12小时的离线时间，而不是8小时。',
    'Great, let me know when you find some.': '太好了，找到了就告诉我。',
    'GREEN LEAF': '绿叶子',
    'Green Leaf Seeds': '绿叶种子',
    'HAMMER': '锤子',
    'HARPOON': '鱼叉',
    'Have any sword equipped.': '有剑装备吗?',
    'Having a magic bonus greater than 20 will not trigger reflect if the enemy hits a 0.': '当敌人的魔法附加值大于20时，不会触发反射。',
    'Heal an additional 1 health per 5 magic bonus.': '每5个魔法附加值额外治疗1点生命值。',
    'FIELDS': '牧场',
    'Fight': '战斗',
    'FIGHT NPC': '与NPC战斗',
    'Fire Mage': '火法师',
    'Furnace': '炉',
    'FURNACE': '炉',
    'GEM/PRISM LIST': '宝石/棱镜列表',
    'Ghost Clothes': '幽灵衣服',
    'GHOST CLOTHES': '幽灵衣服',
    'Giant Snake Tail': '巨蛇的尾巴',
    'Every source of XP is increased by 10%.': '每个资源的经验值增加了10%',
    'Farming Patch': '农业补丁',
    'feathers': '羽毛',
    'Feathers are usually obtained by killing': '羽毛通常是通过杀戮获得的',
    'Fields': '牧场',
    'DONOR COINS': '捐赠的金币',
    'Donor coins may be used to buy temporary buffs that last for 30 days.': '捐赠的金币可以用来购买持续30天的临时增益。',
    'Donor Perk': '捐赠者活跃度',
    'DOTTED GREEN LEAF': '有斑点的绿叶',
    'dotted green leaf @ min': '有斑点的绿叶@ 小',
    'Dotted Green Leaf Seeds': '有斑点的绿叶种子',
    'DOTTED LEAF': '有斑点的叶子',
    'Drills': '钻孔机',
    'EASY': '简单',
    'EMPTY VIAL': '空瓶',
    'Click to bind coins to your account': '点击绑定金币到您的帐户',
    'Click to operate': '点击操作',
    'compost pot just speed up farming like dh': '堆肥盆只是加快农业速度像dh',
    'COOKING OVEN': '烹饪炉',
    'craft a cauldron': '制造一个大锅',
    'Crafting Mould': '制作模具',
    'Defeated': '打败了',
    'An archer is in need of feathers to finish crafting his arrows!': '弓箭手需要羽毛来完成他的箭!',
    'Base damage': '基础伤害',
    'Base heal': '基础治疗',
    'Base poison': '基础毒药',
    'brewing': '酿造',
    'Broken Stinger': '破碎的鸡尾酒',
    'Burn rate: NaN': '烧毁率:NaN',
    'BUSHY': '灌木茂密的',
    'Can be used to craft a specific item.': '可以用来制作一个特定的物品。',
    'Can I buy your bow?': '我可以买你的弓吗?',
    '+1 damage per 3 magic bonus.': '每3点魔法加值+1点伤害。',
    'A primary brewing ingredient.': '主要的酿造原料。',
    'A secondary brewing ingredient.': '一种二级酿造原料。',
    '': '',
    '': '',
    '': '',
    '': '',
