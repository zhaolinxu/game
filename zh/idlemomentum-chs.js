...
var cnItems = {
    ...
    'Reduces the amount of AP needed to reach the next ascension boost by 1x per level.': '将达到下一个转生提升所需的转生点数量每等级降低1倍。',
    '': '',
    '': '',
    '': '',
    '': '',
...
var cnRegReplace = new Map([
    ...
    [/^([\d\.,]+) AP \(([\d\.,]+)$/, '$1 转生点 \($2'],
    [/^(\d+) MP$/, '$1 MP'],
    [/^Upgraded from (\d+)x to (\d+)x$/, '从 $1 升级到 $2'],
